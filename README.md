...
This Playbook is based on [**The Digital Services Playbook**](https://playbook.cio.gov/ "Link to the Digital Services Playbook"). 

## We Want Your Feedback
We encourage your feedback and suggestions on these documents. Content and feature suggestions and discussions are welcome via [GitHub Issues](https://github.com/brighthive/playbook-template/issues). You may also propose changes to the content directly by submitting a [pull request](https://help.github.com/articles/creating-a-pull-request "More Information on Submitting Pull Requests").
